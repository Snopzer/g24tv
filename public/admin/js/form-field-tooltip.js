...
function DHTMLgoodies_formTooltip()
{
	...
	this.imagePath = '../public/admin/images/';
	this.arrowImageFile = 'green-arrow.gif';
	this.arrowImageFileRight = 'green-arrow-right.gif';
	this.tooltipWidth = 800;
	this.tooltipBgColor = '#0b0b0b';
	...
	this.arrowTopHeight = 3;			// Default height of arrow at the top of tooltip
...
DHTMLgoodies_formTooltip.prototype = {
	...
	__createTooltip : function()
	{
		...
		if(this.isMSIE){
			...
			this.tooltipIframeObj.maxWidth = this.tooltipWidth;
			...
			this.tooltipIframeObj.style.maxWidth = (this.tooltipWidth) + 'px';
	...
	{	
		...
		this.tooltipDiv.style.maxWidth=this.tooltipWidth + 'px';
