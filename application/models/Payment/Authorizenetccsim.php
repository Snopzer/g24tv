...
*/
  ...
  class Model_Payment_Authorizenetccsim {
    var $code, $title, $description, $enabled;

// class constructor
    function Model_Payment_Authorizenetccsim() {
      //global $order;
      ...
      $this->code = 'Authorizenetccsim';
      $this->title = @constant('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_TITLE')==""?"Authorise.net CC Sim":MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_TITLE;
...
//	  echo "in update status".$this->enabled." ".MODULE_PAYMENT_AUTHORIZENET_CC_SIM_ZONE;
//exit;
    ...
    function process_button() {
      ...
      $tax_value = 0;
	//	echo "tax group ".$order->info['tax_groups'];
	...
	$this->db->insert('r_configuration',array('configuration_title'=>'Title','configuration_key'=>'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_TITLE','configuration_value'=>'Authorise.net CC Sim','configuration_description'=>'enter title to display in front end','configuration_group_id'=>'6','sort_order'=>'0','date_added'=>new Zend_Db_Expr('NOW()')));
	  ...
	  $this->db->query("insert into r_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Login ID', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_LOGIN_ID', '', 'The login ID used for the Authorize.net service', '6', '0', now())");

	  $this->db->query("insert into r_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Transaction Key', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TRANSACTION_KEY', '', 'Transaction key used for encrypting data', '6', '0', now())");

      $this->db->query("insert into r_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MD5 Hash', 'MODULE_PAYMENT_AUTHORIZENET_CC_SIM_MD5_HASH', '', 'The MD5 hash value to verify transactions with', '6', '0', now())");
