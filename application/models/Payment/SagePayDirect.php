...
*/
  ...
  class Model_Payment_SagePayDirect {
    var $code, $title, $description, $enabled;

// class constructor
    function Model_Payment_SagePayDirect() {
      //global $order;
	  $order=$_SESSION['order'];
      $this->signature = 'sage_pay|sage_pay_direct|1.0|2.3';

      $this->code = 'SagePayDirect';
      $this->title =@constant('MODULE_PAYMENT_SAGE_PAY_DIRECT_TEXT_TITLE')==""?"SagePay Direct Payment Gateway":MODULE_PAYMENT_SAGE_PAY_DIRECT_TEXT_TITLE;
...
//exit;
      ...
      if ($return['Status'] == '3DAUTH') {
		...
		$sage_pay_direct_acsurl=$_SESSION['sage_pay_direct_acsurl'];
		$sage_pay_direct_pareq=$_SESSION['sage_pay_direct_pareq'];
		$sage_pay_direct_md=$_SESSION['sage_pay_direct_md'];
...
//exit("out side");
    ...
    function install() {
				  ...
				  $this->db->insert('r_configuration',array('configuration_title'=>'Title','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_TEXT_TITLE','configuration_value'=>'SagePay Direct Payment Gateway','configuration_description'=>'enter title to display in front end','configuration_group_id'=>'6','sort_order'=>'0','date_added'=>new Zend_Db_Expr('NOW()')));

		$this->db->insert('r_configuration',array('configuration_title'=>'Enable Sage Pay Direct Module','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_STATUS','configuration_value'=>'False','configuration_description'=>'Do you want to accept Sage Pay Direct payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Vendor Login Name','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_VENDOR_LOGIN_NAME','configuration_value'=>'','configuration_description'=>'The vendor login name to connect to the gateway with.','configuration_group_id'=>'6','sort_order'=>'0','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Verify With CVC','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_VERIFY_WITH_CVC','configuration_value'=>'True','configuration_description'=>'Verify the credit card with the billing address with the Credit Card Verification Checknumber (CVC)?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Transaction Method','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_TRANSACTION_METHOD','configuration_value'=>'Authenticate','configuration_description'=>'The processing method to use for each transaction.','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'Authenticate\', \'Deferred\', \'Payment\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Transaction Server','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_TRANSACTION_SERVER','configuration_value'=>'Simulator','configuration_description'=>'Perform transactions on the production server or on the testing server.','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'Live\', \'Test\', \'Simulator\'),','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Sort order of display.','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_SORT_ORDER','configuration_value'=>'0','configuration_description'=>'Sort order of display. Lowest is displayed first.','configuration_group_id'=>'6','sort_order'=>'0','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Payment Zone','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ZONE','configuration_value'=>'0','configuration_description'=>'If a zone is selected, only enable this payment method for that zone.','configuration_group_id'=>'6','sort_order'=>'2','use_function'=>'tep_get_zone_class_title','set_function'=> 'tep_cfg_pull_down_zone_classes(','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Set Order Status','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ORDER_STATUS_ID','configuration_value'=>'0','configuration_description'=>'Set the status of orders made with this payment module to this value','configuration_group_id'=>'6','sort_order'=>'0','use_function'=>'tep_get_order_status_name','set_function'=> 'tep_cfg_pull_down_order_statuses(','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'cURL Program Location','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_CURL','configuration_value'=>'/usr/bin/curl','configuration_description'=>'The location to the cURL program application.','configuration_group_id'=>'6','sort_order'=>'0','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Accept Visa','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_VISA','configuration_value'=>'True','configuration_description'=>'Do you want to accept Visa payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Accept Mastercard','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_MC','configuration_value'=>'True','configuration_description'=>'Do you want to accept Mastercards payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Accept Visa Delta/Debit','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_DELTA','configuration_value'=>'True','configuration_description'=>'Do you want to accept Visa Delta/Debit payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));
$this->db->insert('r_configuration',array('configuration_title'=>'Accept Solo','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_SOLO','configuration_value'=>'True','configuration_description'=>'Do you want to accept Solo payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

$this->db->insert('r_configuration',array('configuration_title'=>'Accept Maestro','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_MAESTRO','configuration_value'=>'True','configuration_description'=>'Do you want to accept Maestro payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

      $this->db->insert('r_configuration',array('configuration_title'=>'Accept Visa Electron UK Debit','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_UKE','configuration_value'=>'True','configuration_description'=>'Do you want to accept Visa Electron UK Debit payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

	  $this->db->insert('r_configuration',array('configuration_title'=>'Accept American Express','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_AMEX','configuration_value'=>'True','configuration_description'=>'Do you want to accept American Express payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

	  $this->db->insert('r_configuration',array('configuration_title'=>'Accept Dinners Club','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_DC','configuration_value'=>'True','configuration_description'=>'Do you want to accept Dinners Club payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));

  	  $this->db->insert('r_configuration',array('configuration_title'=>'Accept Japan Credit Bureau','configuration_key'=>'MODULE_PAYMENT_SAGE_PAY_DIRECT_ALLOW_JCB','configuration_value'=>'True','configuration_description'=>'Do you want to accept Japan Credit Bureau payments?','configuration_group_id'=>'6','sort_order'=>'0','set_function'=>'tep_cfg_select_option(array(\'True\', \'False\'), ','date_added'=>new Zend_Db_Expr('NOW()')));
