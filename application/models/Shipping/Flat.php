...
// class constructor
    function Model_Shipping_Flat() {
      ...
      $this->code = 'Flat';
      $this->title =  @constant('MODULE_SHIPPING_FLAT_MAIN_TITLE')==""?"Flat Rate":MODULE_SHIPPING_FLAT_MAIN_TITLE;
...
// class methods
    function quote($method = '') {
	 ...
	 // $order=$_SESSION['order'];
      ...
      /*$this->quotes = array('id' => $this->code,
		...
		$this->quotes = array('id' => $this->code,
                            'module' => @constant('MODULE_SHIPPING_FLAT_MAIN_TITLE'),
                            'methods' => array(array('id' => $this->code,
                                                     'title' => @constant('MODULE_SHIPPING_FLAT_SUB_TITLE'),
                                                     'cost' => MODULE_SHIPPING_FLAT_COST)));
    ...
    function install() {
		...
		$this->db->insert('r_configuration',array('configuration_title'=>'Main Title','configuration_key'=>'MODULE_SHIPPING_FLAT_MAIN_TITLE','configuration_value'=>'Flat Rate','configuration_description'=>'enter main title to be displayed in the front end','configuration_group_id'=>'6','sort_order'=>'1','date_added'=>new Zend_Db_Expr('NOW()')));

	$this->db->insert('r_configuration',array('configuration_title'=>'Sub Title','configuration_key'=>'MODULE_SHIPPING_FLAT_SUB_TITLE','configuration_value'=>'Best Way','configuration_description'=>'enter sub title to be displayed in the front end','configuration_group_id'=>'6','sort_order'=>'2','date_added'=>new Zend_Db_Expr('NOW()')));
    ...
    function keys() {
      return array('MODULE_SHIPPING_FLAT_MAIN_TITLE','MODULE_SHIPPING_FLAT_SUB_TITLE','MODULE_SHIPPING_FLAT_STATUS', 'MODULE_SHIPPING_FLAT_COST', 'MODULE_SHIPPING_FLAT_TAX_CLASS', 'MODULE_SHIPPING_FLAT_ZONE', 'MODULE_SHIPPING_FLAT_SORT_ORDER');
    }
  }
?>
