...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', 'public/uploads/'.base64_decode($_COOKIE["GDK_".$_SERVER['REMOTE_ADDR']]).'/image-cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
class timthumb {
	...
	protected function calcDocRoot(){
		...
		$docRoot ='/home/a9309798/public_html/';
